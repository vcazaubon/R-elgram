// ============================================================
// Réelgram — Mini Design Direction (design-system showcase)
// Ported from design-reference/project/screens-direction.jsx. Optional screen.
// ============================================================
...
export interface DesignDirectionScreenProps {
  onBack: () => void;
}
...
export function DesignDirectionScreen({ onBack }: DesignDirectionScreenProps) {
  const Swatch = ({ name, val, hex }: SwatchProps) => (
  ...
  const Section = ({ title, kicker, children }: SectionProps) => (
